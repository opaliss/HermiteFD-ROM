        ...
        for M in range(3, 7):
            for Nr in range(5, 70, 5):
                setup = SimulationSetupROM(Nx=151,
                                           ...
                                           Ur_e=np.load("../data/ROM/weak_landau/basis_50/basis_" + str(M) + ".npy"),
                                           construct=True,
                                           ions=False)
                ...
                np.save("../data/ROM/weak_landau/sample_" + str(setup.alpha_e) + "/M" + str(setup.M) + "/sol_ROM_u_" + str(
                ...
                np.save("../data/ROM/weak_landau/sample_" + str(setup.alpha_e) + "/M" + str(setup.M) + "/sol_ROM_t_" + str(
